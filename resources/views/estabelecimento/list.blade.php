    ...
    <form action="{{ route('estabelecimento.search') }}" method="post" style="background-color: #f4f4f4; padding: 20px; border-radius: 15px;">
        ...
        <div class="row">
            ...
            <div class="col-4" style="margin-top: 22px;">
                ...
                <a href="{{ url('estabelecimento/create') }}" class="btn btn-success"><i class="fa-solid fa-plus"></i> Novo</a>
            </div>
        </div>
    </form>
                ...
                <div class="card" style="height: 600px; background-color: #f4f4f4;">
                    ...
                    <div class="card-footer text-center">
                        <div class="btn-group mx-auto" role="group">
                            <a href="{{ route('estabelecimento.edit', $item->id) }}" class="btn btn-outline-primary" title="Editar">
